...
class RdvController extends AbstractController
{
    ...
    {
        return $this->render('rdv/home1.html.twig', [
            'rdvs' => $rdvRepository->findAll(),
        ]);
    }
    #[Route('/back2', name: 'app_rdv_index2', methods: ['GET'])]
    public function index2(RdvRepository $rdvRepository): Response
    {
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // Redirect to the show page for the newly created Rdv
